...
from ql.fee.models import CashEntry, Fund, FundDue
from ql.fee.services.reports import generate_fund_report_draft
...
class FundAdmin(MPTTModelAdmin):
    ...
    def generate_report_view(self, request, fund_id):
        ...
        if not self.has_view_permission(request, fund):
            ...
            return redirect('admin:fee_fund_changelist')
    ...
    def generate_report_link(self, obj):
        ...
        url = reverse('admin:fee_fund_generate_report', args=[obj.pk])
