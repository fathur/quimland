...
MESSAGE_TEMPLATE = (
    ...
    "Bapak/Ibu sudah kami aktifkan (ini termasuk tahap 3).\n"
    "\n"
    "Berikut infonya:\n"
    "\U0001f517 Portal: https://warga.quimland.com\n"
    "\U0001f4f1 Username: {username} atau {phone}\n"
    ...
    "Untuk warga lain, akses akan menyusul bertahap (tahap 4, 5, dst) dalam "
    "waktu dekat.\n"
    "\n"
